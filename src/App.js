...
<News apiKey={this.apiKey} setProgress={this.setProgress} key="Sports" pageSize={5} country="in" category="Sports" />
           <News apiKey={this.apiKey}  setProgress={this.setProgress}  key="entertainment" pageSize={5} country="in" category="entertainment" />
          <News apiKey={this.apiKey} setProgress={this.setProgress}   key="Health" pageSize={5} country="in" category="Health" />
            <News  apiKey={this.apiKey}setProgress={this.setProgress}  key="Technology" pageSize={5} country="in" category="Technology" />
            <News apiKey={this.apiKey}  setProgress={this.setProgress}  key="General" pageSize={5} country="in" category="general" />
           <News   apiKey={this.apiKey} setProgress={this.setProgress}  key="Science" pageSize={5} country="in" category="Science" />
           <News apiKey={this.apiKey} setProgress={this.setProgress}  key="Business" pageSize={5} country="in" category="Business" />
