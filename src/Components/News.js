...
export class News extends Component {
    ...
    async updateNews() {
        ...
        const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=02ceb65115d64a8190ca3567b3773afa&page=${this.state.page}&pageSize=${this.props.pageSize}`;
