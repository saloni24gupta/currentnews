...
// import this.props.apiKey from '../apis/newsApi';
...
export class News extends Component {
    ...
    async updateNews() {
        this.props.setProgress(10);
         ...
         const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=dae0d6cdcf9e4b00b67ab8eeb94fa2cf&page=${this.state.page}&pageSize=${this.props.pageSize}`;
